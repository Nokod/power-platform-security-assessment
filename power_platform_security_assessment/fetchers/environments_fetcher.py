...
class EnvironmentsFetcher:
    ...
    def _display_environments(environments):
        ...
        for env in environments:
            ...
            print(
                f'{env.id.split("/")[-1]:<44} {env.properties.displayName:<{max_display_name_length}} {created_by:<20} {env.properties.createdTime:<30} {env.properties.lastActivity.lastActivity.lastActivityTime:<30} {env.properties.environmentSku:<10} {env.properties.provisioningState:<10}')
        print()
